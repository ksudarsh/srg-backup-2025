...
<body>
    ...
    <section class="ttm-row contact-detail mb-50">
        <div class="container res-1199-pl-15 res-1199-pr-15">
            <div class="">
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <h2 class="mb-20 pt-25 res-1199-fs-24 res-991-pt-30 res-991-mb-0">Our Venue</h2>
                        ...
                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style8">
                            ...
                            <div class="featured-content">
                                ...
                                <div class="featured-desc">
                                    <p>spiritualintelligenceprogram@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="spacing-1">
                                ...
                                <div class="section-title with-desc clearfix">
                                    <div class="title-header">
                                        <h5 class="ttm-textcolor-skincolor">Enquire Now</h5>
                                ...
                                <form id="ttm-quote-form" class="row ttm-quote-form clearfix" method="post" action="#">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input name="phone" type="email" placeholder="Your Phone*"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <textarea name="Message" rows="4" placeholder="Message" required="required"
                                                class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-50 res-767-mb-0">
                                        <button type="submit" id="submit"
                                            class="ttm-btn ttm-btn-size-md ttm-textcolor-white ttm-btn-color-darkgrey"
                                            value="">
                                            Send Message
                                        </button>
                                    </div>
